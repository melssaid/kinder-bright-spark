    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold">{avgSentenceLength} words</span>
        ...
        <p className="text-xs text-muted-foreground italic">
          {vocabAbove && sentenceAbove
            ? "Exceeding age benchmarks — consider enrichment activities!"
            : !vocabAbove && !sentenceAbove
            ? "Below benchmarks — consider speech support consultation."
            : "Developing well with room for targeted growth."}
        </p>
      </CardContent>
    </Card>
  );
